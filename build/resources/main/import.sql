...
-- insert INTO user (id, mobile, password, name , cnname) values (1, '222222', '$2a$10$062/nG2Z7dspW6cdMzxJOOpAjIMlSTPFuMkhi6nMopnXdSiMQBmg6', 'test2', '哥哥');
-- insert INTO user (id, mobile, password, name, cnname) values (2, '2222222', '$2a$10$062/nG2Z7dspW6cdMzxJOOpAjIMlSTPFuMkhi6nMopnXdSiMQBmg6', 'test3', '老李');
--
